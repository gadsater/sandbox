      ...
      000003 02 00 62         [24]  300 	ljmp	_main
                                    ...
                                    308 ;------------------------------------------------------------
                                    309 ;i                         Allocated to registers 
                                    310 ;------------------------------------------------------------
                                    311 ;	prog1.c:3: void main() {
                                    312 ;	-----------------------------------------
                                    313 ;	 function main
                                    314 ;	-----------------------------------------
      000062                        315 _main:
                           ...
                           000001   322 	ar1 = 0x01
                           000000   323 	ar0 = 0x00
                                    324 ;	prog1.c:5: P1 = 0x00;
      000062 75 90 00         [24]  325 	mov	_P1,#0x00
                                    326 ;	prog1.c:7: for (i=0; i<=255; i++) {
      000065                        327 00105$:
                                    328 ;	prog1.c:8: P1++;
      000065 05 90            [12]  329 	inc	_P1
                                    330 ;	prog1.c:7: for (i=0; i<=255; i++) {
                                    331 ;	prog1.c:11: }
      000067 80 FC            [24]  332 	sjmp	00105$
                                    333 	.area CSEG    (CODE)
                                    334 	.area CONST   (CODE)
                                    335 	.area XINIT   (CODE)
